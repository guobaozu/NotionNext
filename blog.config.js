...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'dd1c6816a9b54023af87c42a6a348b1e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '云哥', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.chat918.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ChatGPT,AI,人工智能,知识库,智能客服,chatgpt,云哥聊AI', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'zhanyun@chaton.fun', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/u/7869156655', // 你的微博个人主页
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '鲁ICP备2021008906号-2', // 备案号 闽ICP备XXXXXXX
  ...
  MY_GPT_CHAT_ENABLE: process.env.NEXT_PUBLIC_MY_GPT_CHAT_ENABLE || false,
  ...
  SEO_BAIDU_SITE_VERIFICATION: process.env.NEXT_PUBLIC_SEO_BAIDU_SITE_VERIFICATION || 'codeva-3KlxQSqsnj', // Remove the value or replace it with your own google site verification code
